...
LINE_WIDTH = 5  # largura da linha divisória
WIN_LINE_WIDTH = 15  # kargura da linha de vitoria
BOARD_ROWS = 3  # quantidade de linhas do quadro
BOARD_COLS = 3  # quantidade de colunas do quadro
SQUARE_SIZE = 200  # tamanho dos quadros
CIRCLE_RADIUS = 60  # tamanho do circulo
CIRCLE_WIDTH = 15  # preenchimento do circulo
CROSS_WIDTH = 25  # largura do x
SPACE = 55  # espaçamento

# cores
BG_COLOR = (21, 48, 92)
LINE_COLOR = (255, 255, 255)
CIRCLE_COLOR = (239, 231, 200)
CROSS_COLOR = (255, 20, 66)
...
# desenha as linhas separatórias
...
# marca a peça no local selecionado
...
# desenha a linha da vitória na vertical
...
# desenha a linha da vitória na horizontal
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and not game_over:
            ...
            # publish.publish(client,f"linha: {clicked_row}, coluna: {clicked_col}. Jogador: {player}")
